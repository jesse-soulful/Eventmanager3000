...
CREATE TABLE "new_SubLineItemType" (
    ...
    CONSTRAINT "SubLineItemType_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE INDEX "SubLineItemType_categoryId_idx" ON "SubLineItemType"("categoryId");
CREATE UNIQUE INDEX "SubLineItemType_moduleType_categoryId_name_key" ON "SubLineItemType"("moduleType", "categoryId", "name");
